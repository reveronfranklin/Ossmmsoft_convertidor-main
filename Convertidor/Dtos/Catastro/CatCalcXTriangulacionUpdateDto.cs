namespace Convertidor.Dtos.Catastro
{
    public class CatCalcXTriangulacionUpdateDto
    {
        ...
        public decimal CatetoA { get; set; }
        public decimal CatetoB { get; set; }
        public decimal CatetoC { get; set; }
        public decimal AreaParcial { get; set; }
        public decimal AreaComplementaria { get; set; }
