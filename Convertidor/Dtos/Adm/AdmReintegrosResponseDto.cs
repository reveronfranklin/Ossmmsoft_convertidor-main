...
{
    public class AdmReintegrosResponseDto
    {
        public int CodigoReintegro { get; set; }
        public int ANO { get; set; }
        public int CodigoCompromiso { get; set; }
        public DateTime FechaReintegro { get; set; }
        public string FechaReintegroString { get; set; }
        public FechaDto FechaReintegroObj { get; set; }
        ...
        public string FechaDepositoString { get; set; }
        public FechaDto FechaDepositoObj { get; set; }
