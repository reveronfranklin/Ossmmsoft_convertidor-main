...
{
    public class RH_H_RETENCIONES_SSO
    {
        ...
        public int MONTO_SSO_TRABAJADOR { get; set; }
        public int MONTO_RPE_TRABAJADOR { get; set; }

        public int MONTO_SSO_PATRONO { get; set; }

        public int MONTO_RPE_PATRONO { get; set; }
