    ...
    public class AdmDetalleSolicitudRepository: IAdmDetalleSolicitudRepository
    {
        ...
        public async Task<TotalesResponseDto> GetTotales(int codigoPresupuesto, int codigoSolicitud)
        {
            ...
            if (detalle.Count > 0)
            {
                ...
                if (detalleImpuesto != null)
                {
                    ...
                    if (result.BaseImponible == 0) result.BaseImponible =  result.Base;
        ...
        public async  Task RecalculaImpuesto(int codigoPresupuesto,int codigoSolicitud)
        {
            ...
            try
            {
                ...
                if (detalleImpuesto != null)
                {
                    FormattableString xqueryDiario = $"UPDATE ADM.ADM_DETALLE_SOLICITUD SET MONTO_IMPUESTO=0,TOTAL_MAS_IMPUESTO=TRUNC(TOTAL, 2)  WHERE CODIGO_PRESUPUESTO={codigoPresupuesto} AND CODIGO_SOLICITUD ={codigoSolicitud}";
