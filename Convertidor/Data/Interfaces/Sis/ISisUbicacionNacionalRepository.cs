...
namespace Convertidor.Data.Interfaces.Sis
{
		...
		ISisUbicacionNacionalRepository
	{
        ...
        Task<List<SIS_UBICACION_NACIONAL>> GetEstados();
         Task<List<SIS_UBICACION_NACIONAL>> GetEstadosPorPais(int codigoPais);
        Task<List<SIS_UBICACION_NACIONAL>> GetMunicipios();
        Task<List<SIS_UBICACION_NACIONAL>> GetMunicipiosPorPaisEstado(int codigoPais,int codigoEstado);
       ...
       Task<List<SIS_UBICACION_NACIONAL>>  GetSectoresPorPaisEstadoMunicipioCiudadParroquias(FiltersSector filter);
       Task<List<SIS_UBICACION_NACIONAL>>  GetUrbanizacionesPorPaisEstadoMunicipioCiudadParroquiasSector(FiltersUrbanizacion filter);
