...
{
    public class DataContextRhC : DbContext
    {
        public DataContextRhC(DbContextOptions<DataContextRhC> options) : base(options)
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                builder.HasNoKey();
                builder.ToTable("RH_V_REPORTE_NOMINA_TEMPORAL");
            });
            modelBuilder.Entity<RH_V_REPORTE_NOMINA_HISTORICO>(builder =>
            {
                builder.HasNoKey();
            ...
            modelBuilder.Entity<RH_CONCEPTOS_ACUMULA>(builder =>
            {
                builder.HasKey(table => new
                {
                    table.CODIGO_CONCEPTO_ACUMULA,
