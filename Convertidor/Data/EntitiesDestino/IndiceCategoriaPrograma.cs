...
{
    public class IndiceCategoriaPrograma
    {
        public IndiceCategoriaPrograma()
        {
            HistoricoPersonalCargo = new HashSet<HistoricoPersonalCargo>();
        }
        ...
        public virtual ICollection<HistoricoPersonalCargo> HistoricoPersonalCargo { get; set; }
