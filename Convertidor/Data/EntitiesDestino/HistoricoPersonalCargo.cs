...
{
    public class HistoricoPersonalCargo
    {
        public HistoricoPersonalCargo()
        {
            HistoricoNomina = new HashSet<HistoricoNomina>();
        }


        public virtual ICollection<HistoricoNomina> HistoricoNomina { get; set; }
        ...
        public virtual IndiceCategoriaPrograma IndiceCategoriaPrograma { get; set; }
    }
}
