...
using Convertidor.Services.Adm.AdmLotePagoService;
...
using Convertidor.Services.Adm.Pagos.AdmPagoElectronicoService;
using Convertidor.Services.Adm.Pagos.AdmPagosService;
using Convertidor.Services.Adm.Proveedores.AdmProveedores;
using Convertidor.Services.Adm.Proveedores.AdmProveedoresActividades;
using Convertidor.Services.Adm.Proveedores.AdmProveedoresComunicacion;
using Convertidor.Services.Adm.Proveedores.AdmProveedoresContactos;
using Convertidor.Services.Adm.Proveedores.AdmProveedoresDirecciones;
...
builder.Services.AddTransient<IADM_V_PAGAR_A_LA_OP_TERCEROSServices, ADM_V_PAGAR_A_LA_OP_TERCEROSServices>(); 
...
builder.Services.AddCors(o => o.AddPolicy("corspolicy", builder =>
            {
                builder
                    ...
                    //.AllowAnyOrigin()
                    .WithOrigins("https://ossmmasoft.com.ve:3001","http://localhost:3001","http://localhost:3000", "https://localhost:3000","https://localhost:3001","http://dev.ossmmasoft.com.ve:3001","https://dev.ossmmasoft.com.ve:3443")
                    .AllowAnyMethod()
                    .AllowCredentials()
                    .AllowAnyHeader();
            }));
