...
{
    public class CAT_UBICACION_NACService : ICAT_UBICACION_NACService
    {
        private readonly ICAT_UBICACION_NACRepository _repository;

        public CAT_UBICACION_NACService(ICAT_UBICACION_NACRepository repository)
        {
