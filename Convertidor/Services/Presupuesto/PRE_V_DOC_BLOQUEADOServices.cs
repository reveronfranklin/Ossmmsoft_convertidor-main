...
{
	public class PRE_V_DOC_BLOQUEADOServices : IPRE_V_DOC_BLOQUEADOServices
    {
        ...
        public  PreDetalleDocumentoGetDto MapPreDetalleDocumentoGetDto(PRE_V_DOC_BLOQUEADO entity,int id)
        {
