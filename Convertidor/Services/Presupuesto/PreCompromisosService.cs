...
namespace Convertidor.Services.Presupuesto
{
	public class PreCompromisosService: IPreCompromisosService
    {
        ...
        private readonly IPRE_PRESUPUESTOSRepository _preSupresosRepository;
        ...
        public PreCompromisosService(IPreCompromisosRepository repository,
                                      IPRE_PRESUPUESTOSRepository preSupresosRepository,
                                     ...
                                     )
		{
            ...
            _preSupresosRepository = preSupresosRepository;
        ...
        public async Task<ResultDto<PreCompromisosResponseDto>> Update(PreCompromisosUpdateDto dto)
        {
            ...
            try
            {
                ...
                var codigoPresupuesto = await _preSupresosRepository.GetByCodigo(conectado.Empresa, dto.CodigoPresupuesto);
        ...
        public async Task<ResultDto<PreCompromisosResponseDto>> Create(PreCompromisosUpdateDto dto)
        {
            ...
            try
            {
                ...
                if (codigoCompromiso != null)
                {
                    result.Data = null;
                    result.IsValid = false;
                    result.Message = "Compromiso ya existe";
                    return result;
                }
                if (dto.Ano < 0)
                {
