        ...
        public void Compose(IContainer container)
        {
                ...
                .Table(table =>
            {
                ...
                table.Cell().ColumnSpan(6).Column(col =>
                {
                    ...
                    col.Item().BorderVertical(1).BorderBottom(1).AlignLeft().PaddingLeft(4).Text($"{ModelEncabezado.NombreProveedor} RIF:{ModelEncabezado.Rif} DIRECCION:{ModelEncabezado.Direccion}").Style(headerStyle).FontSize(11);
