...
namespace Convertidor.Services.Adm.Reports.ReporteSolicitudCompromiso;
    ...
    public class SolicitudCompromisoComponent : IComponent
    {
        ...
        public AdmSolicitudesResponseDto ModelSolicitud { get; }
       
        public SolicitudCompromisoComponent( AdmSolicitudesResponseDto modelSolicitud)
        {
        ...
        public void Compose(IContainer container)
        {
            ...
            container.Table(table =>
            {
                ...
                table.Header(header =>
                {
                    ...
                    //table.Cell().Border(1).AlignCenter().PaddingRight(2).Element(CellStyle).Text(.CodigoSolicitante).FontSize(7);
