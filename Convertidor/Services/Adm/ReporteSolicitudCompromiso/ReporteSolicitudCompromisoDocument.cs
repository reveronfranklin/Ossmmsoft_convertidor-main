            ...
            container.Column(column =>
            {
                ...
                column.Item().Row(row =>
                {
                    ...
                    row.RelativeItem().Column(col => 
                    {
                        ...
                        col.Item().Width(120).BorderBottom(1).BorderRight(1).BorderLeft(1).BorderTop(1).AlignCenter().AlignTop().PaddingBottom(5).Text(encabezado.ModelEncabezado.NumeroSolicitud).FontSize(11);
                        ...
                        col.Item().Width(120).BorderBottom(1).BorderRight(1).BorderLeft(1).BorderTop(1).AlignCenter().AlignTop().PaddingBottom(5).Text(encabezado.ModelEncabezado.FechaSolicitud.ToShortDateString()).FontSize(11);
                        col.Item().Width(120).BorderBottom(1).BorderRight(1).BorderLeft(1).BorderTop(1).AlignCenter().AlignTop().PaddingBottom(6).Text("").FontSize(11).SemiBold();
        ...
        void ComposeFooter(IContainer container)
        {
            ...
            container.Table(async table =>
            {
                ...
                footer.Cell().ColumnSpan(4).BorderLeft(1).Column(col =>
                {
                    ...
                    col.Item().BorderLeft(1).PaddingLeft(5).AlignLeft().PaddingBottom(10).Text($"{Model.Encabezado.MontoLetras.ToUpper()}").FontSize(11);
                });
                ...
                footer.Cell().Column(col =>
                {
                    ...
                    {
                        row.RelativeItem().BorderVertical(1).BorderTop(1).AlignTop().AlignCenter().AlignRight().PaddingRight(15).Text($"Elaborado Por :       ").FontSize(11).Bold();
                        row.RelativeItem().BorderVertical(1).BorderTop(1).AlignTop().AlignCenter().Padding(3).PaddingLeft(8).Text($"Revisado Por :       ").FontSize(11).Bold();
                        row.RelativeItem().BorderVertical(1).BorderTop(1).AlignTop().AlignCenter().Padding(3).PaddingLeft(8).Text($"Confirmado Por :       ").FontSize(11).Bold();
