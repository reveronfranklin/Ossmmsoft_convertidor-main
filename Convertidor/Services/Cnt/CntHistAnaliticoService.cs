...
namespace Convertidor.Services.Cnt
{
    public class CntHistAnaliticoService : ICntHistAnaliticoService
    {
        ...
        public async Task<ResultDto<CntHistAnaliticoResponseDto>> Update(CntHistAnaliticoUpdateDto dto)
        {
            ResultDto<CntHistAnaliticoResponseDto> result = new ResultDto<CntHistAnaliticoResponseDto>(null);
            try
            {
                ...
                var resultDto = await MapHistAnalitico(codigoHistAnalitico);
                result.Data = resultDto;
                result.IsValid = true;
                result.Message = "";
            }
        ...
        public async Task<ResultDto<CntHistAnaliticoDeleteDto>> Delete(CntHistAnaliticoDeleteDto dto)
        {
            ResultDto<CntHistAnaliticoDeleteDto> result = new ResultDto<CntHistAnaliticoDeleteDto>(null);
            try
            {
                ...
                var deleted = await _repository.Delete(dto.CodigoHistAnalitico);
