...
namespace Convertidor.Services.Cnt
{
    public class CntBalancesService : ICntBalancesService
    {
        ...
        public async Task<ResultDto<CntBalancesDeleteDto>> Delete(CntBalancesDeleteDto dto)
        {
            ResultDto<CntBalancesDeleteDto> result = new ResultDto<CntBalancesDeleteDto>(null);
            try
            {
                ...
                var deleted = await _repository.Delete(dto.CodigoBalance);
        ...
        public async Task<ResultDto<CntBalancesResponseDto>> GetByCodigo(int codigoBalance)
        {
            ResultDto<CntBalancesResponseDto> result = new ResultDto<CntBalancesResponseDto>(null);
            try
            {

                var balance = await _repository.GetByCodigo(codigoBalance);
                if (balance == null)
                {
                    result.Data = null;
                    result.IsValid = false;
                ...
                var resultDto = await MapBalances(balance);
                result.Data = resultDto;
                result.IsValid = true;
                result.Message = "";
