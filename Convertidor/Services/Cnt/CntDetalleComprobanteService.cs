...
namespace Convertidor.Services.Cnt
{
    public class CntDetalleComprobanteService : ICntDetalleComprobanteService
    {
        ...
        public async Task<ResultDto<CntDetalleComprobanteResponseDto>> Update(CntDetalleComprobanteUpdateDto dto)
        {
            ResultDto<CntDetalleComprobanteResponseDto> result = new ResultDto<CntDetalleComprobanteResponseDto>(null);
            try
            {
                ...
                var resultDto = await MapDetalleComprobante(codigoDetalleComprobante);
                result.Data = resultDto;
                result.IsValid = true;
                result.Message = "";
            }
        ...
        public async Task<ResultDto<CntDetalleComprobanteDeleteDto>> Delete(CntDetalleComprobanteDeleteDto dto)
        {
            ResultDto<CntDetalleComprobanteDeleteDto> result = new ResultDto<CntDetalleComprobanteDeleteDto>(null);
            try
            {
        ...
        public async Task<ResultDto<CntDetalleComprobanteResponseDto>> GetByCodigo(int codigoDetalleComprobante)
        {
            ResultDto<CntDetalleComprobanteResponseDto> result = new ResultDto<CntDetalleComprobanteResponseDto>(null);
            try
            {

                var Detallecomprobante = await _repository.GetByCodigo(codigoDetalleComprobante);
                ...
                var resultDto = await MapDetalleComprobante(Detallecomprobante);
                result.Data = resultDto;
                result.IsValid = true;
                result.Message = "";
