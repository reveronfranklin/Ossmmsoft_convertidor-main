...
namespace Convertidor.Services.Cnt
{
    public class TmpDetalleLibroService : ITmpDetalleLibroService
    {
        ...
        public async Task<ResultDto<TmpDetalleLibroResponseDto>> Update(TmpDetalleLibroUpdateDto dto)
        {
            ResultDto<TmpDetalleLibroResponseDto> result = new ResultDto<TmpDetalleLibroResponseDto>(null);
            try
            {
                ...
                var resultDto = await MapTmpDetalleLibro(codigoDetalleLibro);
                result.Data = resultDto;
                result.IsValid = true;
                result.Message = "";
            }
        ...
        public async Task<ResultDto<TmpDetalleLibroDeleteDto>> Delete(TmpDetalleLibroDeleteDto dto)
        {
            ResultDto<TmpDetalleLibroDeleteDto> result = new ResultDto<TmpDetalleLibroDeleteDto>(null);
            try
            {
